...
const WhyChooseUs: React.FC = () => {
  const openTabSection = (evt: React.MouseEvent<HTMLLIElement>, tabName: string) => {
    let i: number;
    let tabcontent: HTMLCollectionOf<Element> = document.getElementsByClassName("wcu_tabs_item");
    ...
    if (element) {
      ...
      element.className += " fadeInUp animated";
    }
              ...
              <div className="row align-items-center">
                ...
                <div className="col-lg-3">
                  <ul className="tabs">
                    <li
                      className="current"
                      onClick={(e) => openTabSection(e, "wcu_tab1")}
                    >
                      <i className="bx bx-chevron-left"></i>
                      Industry Experts
                    </li>
                    
                    <li onClick={(e) => openTabSection(e, "wcu_tab2")}>
                      <i className="bx bx-chevron-left"></i>
                      Dedicated Team
                    </li>

                    <li onClick={(e) => openTabSection(e, "wcu_tab3")}>
                      <i className="bx bx-chevron-left"></i>
                      Outcome Focused
                    </li>

                    <li onClick={(e) => openTabSection(e, "wcu_tab4")}>
                      <i className="bx bx-chevron-left"></i>
                      High Quality Service
                    </li>

                    <li onClick={(e) => openTabSection(e, "wcu_tab5")}>
                      <i className="bx bx-chevron-left"></i>

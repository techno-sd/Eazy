...
const InnovativeElectronicProtection: React.FC = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="home-control-content white-color-content">
                <h3>
                  ...
                  <Tabs>
                    ...
                    <TabPanel>
                      <p>
                        ...
                        Adipiscing eleifend poteder mattis viverra lorem ipsum
                        dolor sit amet consecte adipisci ng elit adipiscingdiper
            ...
            <div className="col-lg-6 col-md-12">
              <div className="home-control-image">
                <Image
                  src="/img/home-7-8-9/home-control/home-control.jpg"
                  alt="image"
                  width={750}
                  height={800}
                />
